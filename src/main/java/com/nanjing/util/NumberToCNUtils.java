...
public class NumberToCNUtils {
     ...
     * @return
     */
    public static String number2CNMontrayUnit(Long money) {
        if (money == null) {
            BigDecimal numberOfMoney = new BigDecimal(0L);
            return NumberToCNUtils.number2CNMontrayUnit(numberOfMoney);
        } else {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(NumberToCNUtils.number2CNMontrayUnit(0L));
